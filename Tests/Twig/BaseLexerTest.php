...
namespace PrestaShop\TranslationToolsBundle\Tests\Twig;

use PrestaShop\TranslationToolsBundle\Tests\PhpUnit\TestCase;
use PrestaShop\TranslationToolsBundle\Twig\BaseLexer;
use Twig\Environment;
use Twig\Source;
use Twig\Token;

class BaseLexerTest extends TestCase
{
    /**
     * @group legacy
     */
    ...
    {
        $lexer = new BaseLexer(new Environment($this->createMock('\Twig\Loader\LoaderInterface')));
        $stream = $lexer->tokenize(new Source('{{ foo }}', 'foo'));
